    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]  ">
          ...
          >
            Unleash the Power of Microservices with {` `}
          ...
          <p
            ...
            data-aos="slide-up" // Changed AOS animation type for the paragraph
            data-aos-delay="200" // Optional delay for the paragraph
            data-aos-duration="600" // Optional duration for the paragraph
          >
